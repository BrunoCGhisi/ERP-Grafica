...
def insumosController():
    ...
    if request.method == 'POST':
        try:
            ...
            insumos = Insumos(data['nome'], data['tipo'], data['keyWord'], data['idCategoria'], data['preco'], data['tamanho'], data['isEstoque'], data['minEstoque'], data['estoque'])
        ...
        try:
            ...
            newData = {'insumos': [produto.to_dict() for produto in data]} #pegando cada obj produto, e tranformando num dicionario
            return newData, 200
            ...
            try:
                ...
                produto.isEstoque = data.get('isEstoque', produto.isEstoque)
                produto.minEstoque = data.get('minEstoque', produto.minEstoque)   
        ...
        try:
            ...
            produto = Insumos.query.get(id) # vai procurar insumos NO BANCO com esse id
